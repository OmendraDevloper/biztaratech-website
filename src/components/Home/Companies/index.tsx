    ...
    return (
       <section className='text-center' >
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <h2 className="text-midnight_text text-2xl font-semibold">Live & Ongoing Training Programs</h2>
                <div className="py-14 border-b ">
                    <Slider {...settings}>
                        {TruestedCompanies.map((item, i) =>
                            <div key={i}>
                            {/*    <Image src={`${getImagePrefix()}${item.imgSrc}`} alt={item.imgSrc} width={150} height={50} />*/}
